package com.hsh.sunnyweather.ui.weather
...
import com.hsh.sunnyweather.databinding.ActivityWeatherBinding
import com.hsh.sunnyweather.logic.model.Weather
import com.hsh.sunnyweather.logic.model.getSky
...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.swipeRefresh.setColorSchemeColors( resources.getColor(R.color.color_primary))
        refreshWeather()
    ...
    private fun showWeather(weather: Weather) {
        binding?.apply {
            ...
            lifeindex.coldRiskText.text = lifeIndex.coldRisk[0].desc
            lifeindex.dressingText.text = lifeIndex.dressing[0].desc
            lifeindex.ultravioletText.text = lifeIndex.ultraviolet[0].desc
            lifeindex.carWashingText.text = lifeIndex.carWashing[0].desc
